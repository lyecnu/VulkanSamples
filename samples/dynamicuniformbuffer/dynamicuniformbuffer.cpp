...
public:
	...
	void preparePipelines()
	{
		...
		shaderStages[0] = loadShader(getShadersPath() + "dynamicuniformbuffers/base.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
		shaderStages[1] = loadShader(getShadersPath() + "dynamicuniformbuffers/base.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
